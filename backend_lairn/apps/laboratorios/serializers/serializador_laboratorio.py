...
class SerializadorLaboratorio(serializers.ModelSerializer):
    ...
    class Meta:
        model = Laboratorio
        fields = ['id', 'titulo', 'instrucciones', 'max_intentos', 'fecha_limite', 'creado_en', 'total_preguntas']
...
class SerializadorLaboratorioDetalleDocente(serializers.ModelSerializer):
    ...
    preguntas = SerializadorPreguntaCodigoDocente(many=True, read_only=True)

    class Meta:
        model = Laboratorio
        fields = ['id', 'titulo', 'instrucciones', 'max_intentos', 'fecha_limite', 'creado_en', 'preguntas']
        read_only_fields = ['id', 'creado_en']
...
class SerializadorLaboratorioDetalleEstudiante(serializers.ModelSerializer):
    ...
    preguntas = SerializadorPreguntaCodigoEstudiante(many=True, read_only=True)
