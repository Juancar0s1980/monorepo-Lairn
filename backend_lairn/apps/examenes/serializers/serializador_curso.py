...
class SerializadorCrearCurso(serializers.ModelSerializer):
    class Meta:
        model = Curso
        fields = ['id', 'nombre', 'descripcion', 'codigo', 'creado_en', 'campo_estudio_habilitado', 'plan_aula_cargado']
        read_only_fields = ['codigo', 'creado_en', 'campo_estudio_habilitado', 'plan_aula_cargado']
...
class SerializadorCursoEstudiante(serializers.ModelSerializer):
    ...
    class Meta:
        model = Curso
        fields = ['id', 'nombre', 'descripcion', 'docente', 'creado_en', 'campo_estudio_habilitado', 'plan_aula_cargado']
